...
contract BrevisToken is ERC20, Ownable2Step {
    uint256 private constant MAX_SUPPLY = 1_000_000_000e18; // 1 billion tokens with 18 decimals

    constructor() ERC20("Brevis Token", "BREV") Ownable(msg.sender) {}
