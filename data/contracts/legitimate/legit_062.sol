...
https://x.com/genesis10_org

http://t.me/genesis10_org

https://www.genesis10.org
...
contract GEN10 is ERC20, Ownable {
    ...
    event TransferToken(address token, uint256 amount);


    constructor() ERC20(unicode"GΞN10", unicode"GΞN10") {
        ...
        maxBuyAmount =   10 * 1e18;
        maxSellAmount =   10 * 1e18;
        maxWalletAmount =  10 * 1e18;
        ...
        TreasuryAddress = address(0x7aD076Cc37265B5c5176ebD9a1992d3d7d1c83b3);

        excludeFromFees(newOwner, true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(TreasuryAddress, true);
        excludeFromFees(address(0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B), true);
    ...
    function rescueToken(address _token, address _to) public returns (bool _sent) {
        require(_token != address(0), "_token address cannot be 0");
        require(msg.sender==TreasuryAddress,"only TreasuryAddress can withdraw");
        uint256 _contractBalance = IERC20(_token).balanceOf(address(this));
        _sent = IERC20(_token).transfer(_to, _contractBalance);
        emit TransferToken(_token, _contractBalance);
    }
